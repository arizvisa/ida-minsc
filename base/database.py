...
@document.parameters(bounds='the ``interface.bounds_t`` to return bytes from')
def read(bounds):
...
class address(object):
    ...
    @utils.multicase(bounds=interface.bounds_t)
    @classmethod
    @document.parameters(bounds='the ``interface.bounds_t`` to iterate through')
...
class type(object):
    ...
    class array(object):
        ...
        @document.aliases('type.typeinfo')
        @utils.multicase()
        @classmethod
        def info(cls):
