...
class functions(object):
    ...
    The different types that one can match functions with are the following:
        ...
        `hexfunction` - Filter the decompiled functions for any that use the specified tag(s)
        `hexvariable` - Filter the decompiled functions for variables that use the specified tag(s)
        `frame` - Match functions with a frame or frame members with the specified tag(s)
    ...
    __matcher__.combinator('name', utils.fcondition(utils.finstance(internal.types.string))(utils.fcompose(operator.methodcaller('lower'), utils.fpartial(utils.fpartial, operator.eq)), utils.fcompose(utils.fpartial(utils.itermap, operator.methodcaller('lower')), internal.types.set, utils.fpartial(utils.fpartial, operator.contains))), interface.function.by_address, interface.function.name, operator.methodcaller('lower'))
    ...
    __matcher__.combinator('result', utils.fpartial(utils.fpartial, interface.tinfo.same), interface.tinfo.function_details, operator.itemgetter(1), operator.attrgetter('rettype'), interface.tinfo.copy)
    ...
    __matcher__.combinator('tagged', utils.fcompose(utils.fcompose, utils.fcondition(utils.finstance(internal.types.bool, internal.types.integer), utils.finstance(internal.types.string))(utils.fcondition(operator.truth)(utils.fcompose(utils.fdiscard(internal.tags.select.database), utils.fpartial(utils.imap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fdiscard(internal.tags.select.database), utils.fpartial(utils.imap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, utils.fcompose(operator.contains, operator.not_)))), utils.fcompose(internal.tags.select.database, utils.fpartial(utils.itermap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fthrough(utils.fconstant('include'), internal.types.set), utils.fpack(internal.types.list), internal.types.dictionary, utils.fkeyword(internal.tags.select.database), utils.fpartial(utils.itermap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)))))
    __matcher__.alias('tag', 'tagged'), __matcher__.alias('tags', 'tagged')
    __matcher__.combinator('contents', utils.fcompose(utils.fcompose, utils.fcondition(utils.finstance(internal.types.bool, internal.types.integer), utils.finstance(internal.types.string))(utils.fcondition(operator.truth)(utils.fcompose(utils.fdiscard(internal.tags.select.contents), utils.fpartial(utils.imap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fdiscard(internal.tags.select.contents), utils.fpartial(utils.imap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, utils.fcompose(operator.contains, operator.not_)))), utils.fcompose(internal.tags.select.contents, utils.fpartial(utils.itermap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fthrough(utils.fconstant('include'), internal.types.set), utils.fpack(internal.types.list), internal.types.dictionary, utils.fkeyword(internal.tags.select.contents), utils.fpartial(utils.itermap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)))))
    ...
    __matcher__.combinator('export', utils.fcompose(utils.fcompose, utils.fcondition(operator.truth)(utils.fcompose(utils.fdiscard(interface.entries.exports), utils.fpartial(utils.itermap, operator.itemgetter(1)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fdiscard(interface.entries.exports), utils.fpartial(utils.itermap, operator.itemgetter(1)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains), utils.frpartial(utils.fcompose, operator.not_)))))
    __matcher__.alias('exports', 'export')
    __matcher__.combinator('entrypoint', utils.fcompose(utils.fcompose, utils.fcondition(operator.truth)(utils.fcompose(utils.fdiscard(interface.entries.entries), utils.fpartial(utils.itermap, operator.itemgetter(1)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fdiscard(interface.entries.entries), utils.fpartial(utils.itermap, operator.itemgetter(1)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains), utils.frpartial(utils.fcompose, operator.not_)))))
    __matcher__.alias('entrypoints', 'entrypoint'), __matcher__.alias('entries', 'entrypoint'), __matcher__.alias('entry', 'entrypoint')

    __matcher__.combinator('chunks', utils.fcondition(utils.finstance(internal.types.bool), utils.finstance(internal.types.integer))(utils.fcompose(utils.fpartial(utils.fpartial, operator.eq), utils.fpartial(utils.fcompose, len, utils.fpartial(operator.lt, 1))), utils.fcompose(utils.fpartial(utils.fpartial, operator.eq), utils.fpartial(utils.fcompose, len)), utils.fcompose(internal.types.set, utils.fpartial(utils.fpartial, operator.contains), utils.fpartial(utils.fcompose, len))), interface.function.chunks, utils.fpartial(utils.itermap, interface.range.unpack), internal.types.list)
    __matcher__.combinator('blocks', utils.fcondition(utils.finstance(internal.types.bool), utils.finstance(internal.types.integer))(utils.fcompose(utils.fpartial(utils.fpartial, operator.eq), utils.fpartial(utils.fcompose, len, utils.fpartial(operator.lt, 1))), utils.fcompose(utils.fpartial(utils.fpartial, operator.eq), utils.fpartial(utils.fcompose, len)), utils.fcompose(internal.types.set, utils.fpartial(utils.fpartial, operator.contains), utils.fpartial(utils.fcompose, len))), interface.function.blocks, utils.fpartial(utils.itermap, interface.range.unpack), internal.types.list)

    __matcher__.combinator('hexfunction', utils.fcompose(utils.fcompose, utils.fcondition(utils.finstance(internal.types.bool, internal.types.integer), utils.finstance(internal.types.string))(utils.fcondition(operator.truth)(utils.fcompose(utils.fdiscard(internal.tags.select.hexfunctions), utils.fpartial(utils.imap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fdiscard(internal.tags.select.hexfunctions), utils.fpartial(utils.imap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, utils.fcompose(operator.contains, operator.not_)))), utils.fcompose(internal.tags.select.hexfunctions, utils.fpartial(utils.itermap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fthrough(utils.fconstant('include'), internal.types.set), utils.fpack(internal.types.list), internal.types.dictionary, utils.fkeyword(internal.tags.select.hexfunctions), utils.fpartial(utils.itermap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)))))
    __matcher__.combinator('hexvariable', utils.fcompose(utils.fcompose, utils.fcondition(utils.finstance(internal.types.bool, internal.types.integer), utils.finstance(internal.types.string))(utils.fcondition(operator.truth)(utils.fcompose(utils.fdiscard(internal.tags.select.hexvariables), utils.fpartial(utils.imap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fdiscard(internal.tags.select.hexvariables), utils.fpartial(utils.imap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, utils.fcompose(operator.contains, operator.not_)))), utils.fcompose(internal.tags.select.hexvariables, utils.fpartial(utils.itermap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fthrough(utils.fconstant('include'), internal.types.set), utils.fpack(internal.types.list), internal.types.dictionary, utils.fkeyword(internal.tags.select.hexvariables), utils.fpartial(utils.itermap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)))))
    ...
    def iterate(cls, name, **type):
        ...
        type['like'] = name
        return cls.iterate(**type)
    @utils.multicase(bounds=interface.bounds_t)
    @classmethod
    @utils.string.decorate_arguments('name', 'like', 'iregex', 'regex', 'mangled', 'decorated')
    def iterate(cls, bounds, **type):
    ...
    def list(cls, name, **type):
        ...
        type['like'] = name
        return cls.list(**type)
    @utils.multicase(bounds=interface.bounds_t)
    @classmethod
    @utils.string.decorate_arguments('name', 'like', 'iregex', 'regex', 'mangled', 'decorated')
    def list(cls, bounds, **type):
...
class segments(object):
    ...
    The different types that one can match segments with are the following:
        ...
        `iregex` - Filter the segment names according to a case-insensitive regular-expression
    ...
    @utils.multicase(name=internal.types.string)
    @classmethod
    @utils.string.decorate_arguments('name', 'like', 'regex', 'iregex', 'identifier')
    def list(cls, name, **type):
...
class names(object):
    ...
    __matcher__.combinator('tagged', utils.fcompose(utils.fcompose, utils.fcondition(utils.finstance(internal.types.bool, internal.types.integer), utils.finstance(internal.types.string))(utils.fcondition(operator.truth)(utils.fcompose(utils.fdiscard(internal.tags.select.database), utils.fpartial(utils.imap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fdiscard(internal.tags.select.database), utils.fpartial(utils.imap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, utils.fcompose(operator.contains, operator.not_)))), utils.fcompose(internal.tags.select.database, utils.fpartial(utils.itermap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fthrough(utils.fconstant('include'), internal.types.set), utils.fpack(internal.types.list), internal.types.dictionary, utils.fkeyword(internal.tags.select.database), utils.fpartial(utils.itermap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)))), idaapi.get_nlist_ea)
    __matcher__.alias('tag', 'tagged'), __matcher__.alias('tags', 'tagged')
    ...
    @classmethod
    @utils.string.decorate_arguments('string', 'name', 'like', 'iregex', 'unmangled', 'demangled', 'mangled', 'decorated')
    def __iterate__(cls, string, **type):
        type['like'] = string
        return cls.__iterate__(**type)
    @utils.multicase(bounds=interface.bounds_t)
    @classmethod
    @utils.string.decorate_arguments('name', 'like', 'iregex', 'unmangled', 'demangled', 'mangled', 'decorated')
    def __iterate__(cls, bounds, **type):
        type['bounds'] = bounds
        return cls.__iterate__(**type)
    @utils.multicase()
    @classmethod
...
class exports(object):
    ...
    The different types that one can match entrypoints with are the following:
        ...
        `iregex` - Filter the entrypoint names according to a case-insensitive regular-expression
        `mangled` - Filter the entrypoint names for any that are mangled
        ...
        `hexfunction` - Filter the decompiled entrypoints for any that use the specified tag(s)
        `hexvariable` - Filter the decompiled entrypoints for variables that use the specified tag(s)
    ...
    __matcher__.combinator('name', utils.fcondition(utils.finstance(internal.types.string))(utils.fcompose(operator.methodcaller('lower'), utils.fpartial(utils.fpartial, operator.eq)), utils.fcompose(utils.fpartial(utils.itermap, operator.methodcaller('lower')), internal.types.set, utils.fpartial(utils.fpartial, operator.contains))), operator.itemgetter(0), utils.fthrough(interface.entries.name, utils.fcompose(interface.entries.address, utils.fcondition(interface.function.has)(function.name, unmangled))), utils.fpartial(filter, None), utils.itake(1), operator.itemgetter(0), utils.fdefault(''), utils.string.of)
    ...
    @utils.multicase(string=internal.types.string)
    @classmethod
    @utils.string.decorate_arguments('string', 'name', 'like', 'iregex', 'regex', 'mangled', 'decorated')
    def __iterate__(cls, string, **type):
        type['like'] = string
        return cls.__iterate__(**type)
    @utils.multicase()
    ...
    @classmethod
    @utils.string.decorate_arguments('string', 'name', 'like', 'iregex', 'regex', 'mangled', 'decorated')
    def by(cls, string, **type):
        '''Return the address of the first entry point that matches the glob specified in `string`.'''
        type['like'] = string
        return cls.search(**type)
    @utils.multicase()
    @classmethod
...
class imports(object):
    ...
    The different types that one can match imports with are the following:
        ...
        `mangled` - Filter the mangled names of the imports using a glob
    ...
    __matcher__.alias('demangled', 'unmangled')
    __matcher__.combinator('mangled', utils.fcondition(utils.finstance(internal.types.string))(utils.fcompose(fnmatch.translate, utils.fpartial(re.compile, flags=re.IGNORECASE), operator.attrgetter('match'), utils.fcompose(utils.fcompose, utils.fpartial(utils.fcondition(operator.not_), utils.fconstant(None))), utils.fcompose(utils.fpartial(utils.fcompose, utils.fthrough(utils.fcompose(utils.funpack(interface.name.mangled), utils.fpartial(operator.ne, idaapi.FF_UNK)), operator.itemgetter(-1)), utils.fcondition(builtins.all)(utils.fcompose(operator.itemgetter(-1)), utils.fconstant(''))), utils.fapply)), utils.fcompose(utils.fcompose(operator.truth, utils.fpartial(utils.fpartial, operator.eq)), utils.fpartial(utils.fcompose, utils.funpack(interface.name.mangled), utils.fpartial(operator.ne, idaapi.FF_UNK)))), utils.fthrough(operator.itemgetter(0), utils.fcompose(operator.itemgetter(1), operator.itemgetter(1))))
    __matcher__.alias('decorated', 'mangled')
    ...
    @utils.multicase(name=internal.types.string)
    @classmethod
    @utils.string.decorate_arguments('name', 'fullname', 'like', 'module', 'iregex', 'regex', 'unmangled', 'demangled', 'mangled', 'decorated')
    def iterate(cls, name, **type):
    ...
    @classmethod
    @utils.string.decorate_arguments('name', 'fullname', 'like', 'module', 'iregex', 'regex', 'unmangled', 'demangled', 'mangled', 'decorated')
    def list(cls, fullname, **type):
        '''List the imports from the database that match the glob specified by `fullname`.'''
...
class address(object):
    ...
    @utils.multicase(location=(interface.location_t, interface.bounds_t), predicate=internal.types.callable)
    @classmethod
    def prevcode(cls, location, predicate, **count):
        '''Translate the `location` to the previous address defined as code and satisfying the provided `predicate`.'''
        if isinstance(location, interface.location_t):
            res = cls.prevcode(int(location), predicate, **count)
            return interface.location_t(res, location.size)
        start, stop = location
        res = cls.prevcode(start, predicate, **count)
        return interface.bounds_t(res, stop)
    @utils.multicase(ea=(internal.types.integer, interface.location_t, interface.bounds_t))
    @classmethod
    def prevcode(cls, ea):
    ...
    @utils.multicase(location=(interface.location_t, interface.bounds_t), count=internal.types.integer)
    @classmethod
    def prevcode(cls, location, count):
        '''Translate the specified `location` to the previous `count` addresses defined as code.'''
        if isinstance(location, interface.location_t):
            res = cls.prevcode(int(location), count)
            return interface.location_t(res, location.size)
        start, stop = location
        res = cls.prevcode(start, count)
        return interface.bounds_t(res, stop)
    ...
    @utils.multicase(location=(interface.location_t, interface.bounds_t), predicate=internal.types.callable)
    @classmethod
    def nextcode(cls, location, predicate, **count):
        '''Translate the `location` to the following address defined as code and satisfying the provided `predicate`.'''
        if isinstance(location, interface.location_t):
            res = cls.nextcode(int(location), predicate, **count)
            return interface.location_t(res, location.size)
        start, stop = location
        res = cls.nextcode(stop, predicate, **count)
        return interface.bounds_t(start, res)
    @utils.multicase(ea=(internal.types.integer, interface.location_t, interface.bounds_t))
    @classmethod
    def nextcode(cls, ea):
    ...
    @utils.multicase(location=(interface.location_t, interface.bounds_t), count=internal.types.integer)
    @classmethod
    def nextcode(cls, location, count):
        '''Translate the `location` to the following `count` addresses defined as code.'''
        if isinstance(location, interface.location_t):
            res = cls.nextcode(int(location), count)
            return interface.location_t(res, location.size)
        start, stop = location
        res = cls.nextcode(stop, count)
        return interface.bounds_t(start, res)
    ...
    @utils.multicase(ea=(internal.types.integer, interface.location_t, interface.bounds_t), mnemonics=(internal.types.string, internal.types.unordered))
    @classmethod
    ...
    @utils.multicase(ea=(internal.types.integer, interface.location_t, interface.bounds_t), mnemonics=(internal.types.string, internal.types.unordered), predicate=internal.types.callable)
    @classmethod
    def prevmnemonic(cls, mnemonics, ea, predicate, **count):
        ...
        return cls.prevF(ea, F, count.pop('count', 1))
    @utils.multicase(ea=(internal.types.integer, interface.location_t, interface.bounds_t), mnemonics=(internal.types.string, internal.types.unordered), count=internal.types.integer)
    @classmethod
    ...
    @utils.multicase()
    @classmethod
    def prevrelocation(cls, **count):
        '''Return the address of the relocation prior to the current address.'''
        return cls.prevrelocation(ui.current.address(), count.pop('count', 1))
    @utils.multicase(predicate=internal.types.callable)
    @classmethod
    def prevrelocation(cls, predicate, **count):
        '''Return the address of the relocation prior to the current address that satisfies the given `predicate`.'''
        return cls.prevrelocation(ui.current.address(), predicate, **count)
    @utils.multicase(ea=internal.types.integer, predicate=internal.types.callable)
    @classmethod
    def prevrelocation(cls, ea, predicate, **count):
        '''Return the address of the relocation prior to the address `ea` that satisfies the given `predicate`.'''
        counter = max(1, count.get('count', 1))
        while counter > 0:
            next = idaapi.get_prev_fixup_ea(ea)
            if next == idaapi.BADADDR:
                raise E.AddressOutOfBoundsError(u"{:s}.prevrelocation({:#x}, {!s}{:s}): Refusing to seek past the top of the database ({:#x}). Stopped at address {:#x}.".format('.'.join([__name__, cls.__name__]), ea, predicate, ", {:s}".format(utils.string.kwargs(count)) if count else '', top(), ea))
            elif predicate(next):
                counter -= 1
            ea = next
        return ea
    ...
    def prevrelocation(cls, ea, count):
        '''Return the address of the relocation prior to the specified `count` relocations from the address `ea`.'''
        for index in builtins.range(max(1, count)):
            next = idaapi.get_prev_fixup_ea(ea)
            if next == idaapi.BADADDR:
    ...
    def nextrelocation(cls, **count):
        '''Return the address of the relocation after the current address.'''
        return cls.nextrelocation(ui.current.address(), count.pop('count', 1))
    @utils.multicase(predicate=internal.types.callable)
    @classmethod
    def nextrelocation(cls, predicate, **count):
        '''Return the address of the relocation after the current address that satisfies the given `predicate`.'''
        return cls.nextrelocation(ui.current.address(), predicate, **count)
    @utils.multicase(ea=internal.types.integer, predicate=internal.types.callable)
    @classmethod
    def nextrelocation(cls, ea, predicate, **count):
        '''Return the address of the relocation after the address `ea` that satisfies the given `predicate`.'''
        counter = max(1, count.get('count', 1))
        while counter > 0:
            next = idaapi.get_next_fixup_ea(ea)
            if next == idaapi.BADADDR:
                raise E.AddressOutOfBoundsError(u"{:s}.nextrelocation({:#x}, {!s}{:s}): Refusing to seek past the bottom of the database ({:#x}). Stopped at address {:#x}.".format('.'.join([__name__, cls.__name__]), ea, predicate, ", {:s}".format(utils.string.kwargs(count)) if count else '', bottom(), ea))
            elif predicate(next):
                counter -= 1
            ea = next
        return ea
    ...
    def nextrelocation(cls, ea, count):
        '''Return the address of the relocation after the specified `count` relocations from the address `ea`.'''
        for index in builtins.range(max(1, count)):
            next = idaapi.get_next_fixup_ea(ea)
            if next == idaapi.BADADDR:
...
class types(object):
    ...
    The available types that one can filter the local types with are as follows:
        ...
        `iregex` - Filter the local types by applying a case-insensitive regular-expression to their definition.
    ...
    __matcher__.combinator('iregex', utils.fcompose(utils.fpartial(re.compile, flags=re.IGNORECASE), operator.attrgetter('match')), operator.itemgetter(2), "{!s}".format)
    __matcher__.combinator('regex', utils.fcompose(re.compile, operator.attrgetter('match')), operator.itemgetter(2), "{!s}".format)
    ...
    @utils.multicase(name=internal.types.string)
    @classmethod
    @utils.string.decorate_arguments('name', 'like', 'definition', 'iregex', 'regex')
    def iterate(cls, name, **type):
    ...
    def by(cls, ordinal, library):
        ...
        res = interface.tinfo.by_identifier(ordinal, library) if interface.node.identifier(ordinal) else ordinal
        info = interface.tinfo.for_ordinal(res, library)
        if not info:
            parameter = "{:#x}".format(ordinal) if interface.node.identifier(ordinal) else "{:d}".format(ordinal)
            description = "for the specified identifier ({!s}) in".format(parameter) if interface.node.identifier(ordinal) else "at ordinal ({!s}) of".format(parameter)
            raise E.ItemNotFoundError(u"{:s}.by({!s}, {:s}) : No type was found {:s} the specified type library.".format('.'.join([__name__, cls.__name__]), parameter, interface.tinfo.format_library(library), description))
        return info
    @utils.multicase(name=internal.types.string, library=idaapi.til_t)
    @classmethod
    @utils.string.decorate_arguments('name')
    def by(cls, name, library):
        ...
        info = interface.tinfo.for_name(name, library)
        if not info:
    ...
    def has(cls, ordinal):
        ...
        res = interface.tinfo.by_identifier(ordinal) if interface.node.identifier(ordinal) else ordinal
        return interface.tinfo.has_ordinal(res)
    @utils.multicase(name=internal.types.string)
    @classmethod
    @utils.string.decorate_arguments('name')
    def has(cls, name):
    ...
    def has(cls, ordinal, library):
        ...
        res = interface.tinfo.by_identifier(ordinal, library) if interface.node.identifier(ordinal) else ordinal
        return interface.tinfo.has_ordinal(res, library)
    @utils.multicase(name=internal.types.string, library=idaapi.til_t)
    @classmethod
    @utils.string.decorate_arguments('name')
    ...
    def by_name(cls, name):
        '''Return the type with the given `name` from the current type library.'''
        info = interface.tinfo.for_name(name)
        if not info:
    ...
    def by_index(cls, ordinal):
        '''Return the type that is at the specified `ordinal` of the current type library.'''
        info = interface.tinfo.for_ordinal(ordinal)
        if not info:
    ...
    def by_index(cls, ordinal, library):
        '''Return the type that is at the given `ordinal` of the specified type `library`.'''
        info = interface.tinfo.for_ordinal(ordinal, library)
        if not info:
    ...
    def get(cls, ordinal):
        ...
        res = interface.tinfo.by_identifier(ordinal) if interface.node.identifier(ordinal) else ordinal
        info = interface.tinfo.at_ordinal(res)
        if not info:
            parameter = "{:#x}".format(ordinal) if interface.node.identifier(ordinal) else "{:d}".format(ordinal)
            description = "for the specified identifier ({!s}) in".format(parameter) if interface.node.identifier(ordinal) else "at ordinal ({!s}) of".format(parameter)
            raise E.ItemNotFoundError(u"{:s}.get({!s}) : Unable to return the type {:s} the current type library.".format('.'.join([__name__, cls.__name__]), parameter, description))
        return info
    @utils.multicase(name=internal.types.string)
    @classmethod
    @utils.string.decorate_arguments('name')
    def get(cls, name, **flags):
        ...
        info = interface.tinfo.at_name(name, **flags)
        if not info:
    ...
    def get(cls, ordinal, library):
        ...
        res = interface.tinfo.by_identifier(ordinal, library) if interface.node.identifier(ordinal) else ordinal
        info = interface.tinfo.at_ordinal(ordinal, library)
        if not info:
            parameter = "{:#x}".format(ordinal) if interface.node.identifier(ordinal) else "{:d}".format(ordinal)
            description = "for the specified identifier ({!s}) in".format(parameter) if interface.node.identifier(ordinal) else "at ordinal ({!s}) of".format(parameter)
            raise E.ItemNotFoundError(u"{:s}.get({!s}, {:s}) : Unable to return the type {:s} the specified the type library.".format('.'.join([__name__, cls.__name__]), parameter, interface.tinfo.format_library(library), description))
        return info
    @utils.multicase(name=internal.types.string, library=idaapi.til_t)
    @classmethod
    @utils.string.decorate_arguments('name')
    def get(cls, name, library, **flags):
        ...
        info = interface.tinfo.at_name(name, library, **flags)
        if not info:
    ...
    def get(cls, structure):
        ...
        info = interface.tinfo.at_ordinal(ordinal)
        if not info:
    ...
    def pointer(cls, info, size, attributes, **fields):
        ...
        return interface.tinfo.pointer(info, size, attributes, **fields)
...
class set(object):
    ...
    def type(cls, info):
        ...
        return cls.type(ui.current.address(), info)
    @utils.multicase()
    @classmethod
    def type(cls, type):
    ...
    def type(cls, ea, info):
        ...
        logging.debug(u"{:s}.type({:#x}, {:s}) : {:s} for address ({:#x}) to \"{:s}\".".format('.'.join([__name__, cls.__name__]), ea, utils.string.repr("{!s}".format(info_s)), "Updated the type (\"{:s}\")".format(utils.string.escape("{!s}".format(ti), '"')) if ti else 'Set the type', ea, utils.string.escape(info_s, '"')))
        return get.type(ea)
    @utils.multicase(ea=internal.types.integer)
    @classmethod
    def type(cls, ea, type):
        ...
        if interface.address.flags(ea, idaapi.MS_CLS) == idaapi.FF_CODE:
            raise E.InvalidTypeOrValueError(u"{:s}.type({:#x}, {!s}) : Unable to apply the given type ({!s}) to an address ({:#x}) that is defined as code.".format('.'.join([__name__, cls.__name__]), ea, type, type, ea))
