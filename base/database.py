...
class functions(object):
    ...
    __matcher__.boolean('like', utils.fcompose(utils.fbox, utils.fpartial(utils.izip, [utils.fcompose(fnmatch.translate, utils.frpartial(re.compile, re.IGNORECASE), operator.attrgetter('match')), operator.methodcaller('lower')]), utils.fpartial(utils.imap, utils.fcompose(utils.funbox(utils.fapply), utils.fcurry())), utils.funbox(utils.fapply), utils.fcurry(), builtins.bool), function.by, function.name)
    __matcher__.boolean('regex', utils.fpartial(re.search, flags=re.IGNORECASE), function.by, function.name)
...
class names(object):
    ...
    __matcher__.boolean('like', utils.fcompose(utils.fbox, utils.fpartial(utils.izip, [utils.fcompose(fnmatch.translate, utils.frpartial(re.compile, re.IGNORECASE), operator.attrgetter('match')), operator.methodcaller('lower')]), utils.fpartial(utils.imap, utils.fcompose(utils.funbox(utils.fapply), utils.fcurry())), utils.funbox(utils.fapply), utils.fcurry(), builtins.bool), idaapi.get_nlist_name, utils.string.of)
    __matcher__.boolean('regex', utils.fpartial(re.search, flags=re.IGNORECASE), idaapi.get_nlist_name, utils.string.of)
...
class entries(object):
    ...
    __matcher__.boolean('like', utils.fcompose(utils.fbox, utils.fpartial(utils.izip, [utils.fcompose(fnmatch.translate, utils.frpartial(re.compile, re.IGNORECASE), operator.attrgetter('match')), operator.methodcaller('lower')]), utils.fpartial(utils.imap, utils.fcompose(utils.funbox(utils.fapply), utils.fcurry())), utils.funbox(utils.fapply), utils.fcurry(), builtins.bool), idaapi.get_entry_ordinal, idaapi.get_entry_name, utils.string.of)
    __matcher__.boolean('regex', utils.fpartial(re.search, flags=re.IGNORECASE), idaapi.get_entry_ordinal, idaapi.get_entry_name, utils.string.of)
...
class imports(object):
    ...
    __matcher__.boolean('fullname', utils.fcompose(utils.fbox, utils.fpartial(utils.izip, [utils.fcompose(fnmatch.translate, utils.frpartial(re.compile, re.IGNORECASE), operator.attrgetter('match')), operator.methodcaller('lower')]), utils.fpartial(utils.imap, utils.fcompose(utils.funbox(utils.fapply), utils.fcurry())), utils.funbox(utils.fapply), utils.fcurry(), builtins.bool), utils.second, __formatl__.__func__)
    __matcher__.boolean('like', utils.fcompose(utils.fbox, utils.fpartial(utils.izip, [utils.fcompose(fnmatch.translate, utils.frpartial(re.compile, re.IGNORECASE), operator.attrgetter('match')), operator.methodcaller('lower')]), utils.fpartial(utils.imap, utils.fcompose(utils.funbox(utils.fapply), utils.fcurry())), utils.funbox(utils.fapply), utils.fcurry(), builtins.bool), utils.second, __formats__.__func__)
    __matcher__.boolean('module', utils.fcompose(utils.fbox, utils.fpartial(utils.izip, [utils.fcompose(fnmatch.translate, utils.frpartial(re.compile, re.IGNORECASE), operator.attrgetter('match')), operator.methodcaller('lower')]), utils.fpartial(utils.imap, utils.fcompose(utils.funbox(utils.fapply), utils.fcurry())), utils.funbox(utils.fapply), utils.fcurry(), builtins.bool), utils.second, utils.first)
    __matcher__.mapping('ordinal', utils.fcompose(utils.second, utils.funbox(lambda m, n, o: o)))
    __matcher__.boolean('regex', utils.fpartial(re.search, flags=re.IGNORECASE), utils.second, __format__.__func__)
