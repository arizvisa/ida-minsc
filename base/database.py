...
class functions(object):
    ...
    __matcher__.combinator('frame', utils.fcompose(utils.fcompose, utils.fcondition (utils.finstance(internal.types.bool), utils.finstance(internal.types.string))(utils.fcompose(operator.truth, utils.fpartial(utils.fpartial, operator.eq), utils.fpartial(utils.fcompose, utils.fpartial(operator.ne, idaapi.BADNODE))), utils.fcompose(internal.tags.select.owners, utils.fpartial(utils.itermap, utils.nth(0)), utils.fpartial(utils.imap, operator.attrgetter('id')), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(internal.types.set, internal.tags.select.owners, utils.fpartial(utils.itermap, utils.nth(0)), utils.fpartial(utils.imap, operator.attrgetter('id')), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)))), interface.function.by_address, utils.fcondition(operator.truth)(operator.attrgetter('frame'), idaapi.BADADDR))
