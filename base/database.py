...
class types(object):
    ...
    __matcher__.combinator('tagged', utils.fcompose(utils.fcompose, utils.fcondition(utils.finstance(internal.types.bool, internal.types.integer), utils.finstance(internal.types.string))(utils.fcondition(operator.truth)(utils.fcompose(utils.fdiscard(internal.tags.select.structures), utils.fpartial(utils.imap, operator.itemgetter(0)), utils.fpartial(utils.imap, operator.attrgetter('id')), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fdiscard(internal.tags.select.structures), utils.fpartial(utils.imap, operator.itemgetter(0)), utils.fpartial(utils.imap, operator.attrgetter('id')), internal.types.set, utils.fpartial(utils.fpartial, utils.fcompose(operator.contains, operator.not_)))), utils.fcompose(internal.tags.select.structures, utils.fpartial(utils.itermap, operator.itemgetter(0)), utils.fpartial(utils.imap, operator.attrgetter('id')), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(internal.types.set, internal.tags.select.structures, utils.fpartial(utils.itermap, operator.itemgetter(0)), utils.fpartial(utils.imap, operator.attrgetter('id')), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)))), operator.itemgetter(0), interface.tinfo.for_ordinal, interface.tinfo.identifier)
    __matcher__.alias('tag', 'tagged'), __matcher__.alias('tags', 'tagged')
    __matcher__.combinator('members', utils.fcompose(utils.fcompose, utils.fcondition(utils.finstance(internal.types.bool, internal.types.integer), utils.finstance(internal.types.string))(utils.fcondition(operator.truth)(utils.fcompose(utils.fdiscard(internal.tags.select.owners), utils.fpartial(utils.imap, operator.itemgetter(0)), utils.fpartial(utils.imap, operator.attrgetter('id')), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fdiscard(internal.tags.select.owners), utils.fpartial(utils.imap, operator.itemgetter(0)), utils.fpartial(utils.imap, operator.attrgetter('id')), internal.types.set, utils.fpartial(utils.fpartial, utils.fcompose(operator.contains, operator.not_)))), utils.fcompose(internal.tags.select.owners, utils.fpartial(utils.itermap, operator.itemgetter(0)), utils.fpartial(utils.itermap, operator.attrgetter('id')), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(internal.types.set, internal.tags.select.owners, utils.fpartial(utils.itermap, operator.itemgetter(0)), utils.fpartial(utils.itermap, operator.attrgetter('id')), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)))), operator.itemgetter(0), interface.tinfo.for_ordinal, interface.tinfo.identifier)
