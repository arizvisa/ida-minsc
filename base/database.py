...
class functions(object):
    ...
    __matcher__.combinator('frame', utils.fcompose(utils.fcompose, utils.fcondition(utils.finstance(internal.types.bool), utils.finstance(internal.types.string), utils.finstance(internal.types.integer))(utils.fcompose(operator.truth, utils.fpartial(utils.fpartial, operator.eq), utils.fpartial(utils.fcompose, utils.fpartial(operator.ne, idaapi.BADNODE))), utils.fcompose(internal.tags.select.owners, utils.fpartial(utils.itermap, utils.nth(0)), utils.fpartial(utils.imap, operator.attrgetter('id')), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fpartial(utils.fpartial, operator.eq), utils.fpartial(utils.fcompose, idaapi.get_func_by_frame, interface.function.by_address, utils.fcondition(utils.finstance(idaapi.func_t))(operator.attrgetter('frsize'), 0))), utils.fcompose(internal.types.set, utils.fcondition(utils.fcompose(utils.fpartial(utils.imap, utils.finstance(internal.types.string)), builtins.all))(utils.fcompose(internal.types.set, internal.tags.select.owners, utils.fpartial(utils.itermap, utils.nth(0)), utils.fpartial(utils.imap, operator.attrgetter('id')), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fpartial(utils.fpartial, operator.contains), utils.fpartial(utils.fcompose, idaapi.get_func_by_frame, interface.function.by_address, utils.fcondition(utils.finstance(idaapi.func_t))(operator.attrgetter('frsize'), 0))))))), interface.function.by_address, utils.fcondition(operator.truth)(operator.attrgetter('frame'), idaapi.BADADDR))

    __matcher__.combinator('tagged', utils.fcompose(utils.fcompose, utils.fcondition(utils.finstance(internal.types.bool, internal.types.integer), utils.finstance(internal.types.string))(utils.fcondition(operator.truth)(utils.fcompose(utils.fdiscard(internal.tags.select.database), utils.fpartial(utils.imap, utils.nth(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fdiscard(internal.tags.select.database), utils.fpartial(utils.imap, utils.nth(0)), internal.types.set, utils.fpartial(utils.fpartial, utils.fcompose(operator.contains, operator.not_)))), utils.fcompose(internal.tags.select.database, utils.fpartial(utils.itermap, utils.nth(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(internal.types.set, internal.tags.select.database, utils.fpartial(utils.itermap, utils.nth(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)))))
    __matcher__.alias('tag', 'tagged'), __matcher__.alias('tags', 'tagged')
    __matcher__.combinator('contents', utils.fcompose(utils.fcompose, utils.fcondition(utils.finstance(internal.types.bool, internal.types.integer), utils.finstance(internal.types.string))(utils.fcondition(operator.truth)(utils.fcompose(utils.fdiscard(internal.tags.select.contents), utils.fpartial(utils.imap, utils.nth(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fdiscard(internal.tags.select.contents), utils.fpartial(utils.imap, utils.nth(0)), internal.types.set, utils.fpartial(utils.fpartial, utils.fcompose(operator.contains, operator.not_)))), utils.fcompose(internal.tags.select.contents, utils.fpartial(utils.itermap, utils.nth(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(internal.types.set, internal.tags.select.contents, utils.fpartial(utils.itermap, utils.nth(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)))))
...
class names(object):
    ...
    __matcher__.combinator('tagged', utils.fcompose(utils.fcompose, utils.fcondition(utils.finstance(internal.types.bool, internal.types.integer), utils.finstance(internal.types.string))(utils.fcondition(operator.truth)(utils.fcompose(utils.fdiscard(internal.tags.select.database), utils.fpartial(utils.imap, utils.nth(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fdiscard(internal.tags.select.database), utils.fpartial(utils.imap, utils.nth(0)), internal.types.set, utils.fpartial(utils.fpartial, utils.fcompose(operator.contains, operator.not_)))), utils.fcompose(internal.tags.select.database, utils.fpartial(utils.itermap, utils.nth(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(internal.types.set, internal.tags.select.database, utils.fpartial(utils.itermap, utils.nth(0)), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)))), idaapi.get_nlist_ea)
    __matcher__.alias('tag', 'tagged'), __matcher__.alias('tags', 'tagged')
