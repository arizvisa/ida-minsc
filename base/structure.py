...
__matcher__.mapping('visible', operator.not_, operator.itemgetter(-1), 'ptr', utils.fcondition(utils.finstance(idaapi.tinfo_t))(utils.fconstant(True), utils.fcompose('props', functools.partial(operator.and_, getattr(idaapi, 'SF_NOLIST', 0x8)))))
__matcher__.mapping('folded', operator.truth, operator.itemgetter(-1), 'ptr', utils.fcondition(utils.finstance(idaapi.tinfo_t))(utils.fconstant(False), utils.fcompose('props', functools.partial(operator.and_, getattr(idaapi, 'SF_HIDDEN', 0x20)))))
__matcher__.mapping('union', operator.truth, operator.itemgetter(-1), 'ptr', internal.structure.union)
__matcher__.mapping('library', operator.truth, operator.itemgetter(-1), 'ptr', utils.fcondition(utils.finstance(idaapi.tinfo_t))(utils.fconstant(True), utils.fcompose('props', functools.partial(operator.and_, getattr(idaapi, 'SF_GHOST', 0x1000) | getattr(idaapi, 'SF_TYPLIB', 0x10)))))
