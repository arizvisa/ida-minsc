...
in detail later at :ref:`tag-encoding`. These values can then later be queried
...
interfere with the :ref:`tag-format` with their backslash-prefixed
...
(see :ref:`tag-format`) will be internally treated as the "empty" tag.
