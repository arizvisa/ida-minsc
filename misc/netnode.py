...
class blob(object):
    ...
    def set(cls, nodeidx, tag, value, start=0):
        ...
        """
        node = utils.get(nodeidx)
        return netnode.setblob(node, value.tobytes() if isinstance(value, internal.types.memoryview) else value, start, tag)
...
class sup(object):
    ...
    def set(cls, nodeidx, index, value, tag=None):
        ...
        node = utils.get(nodeidx)
        return netnode.supset(node, index, value.tobytes() if isinstance(value, internal.types.memoryview) else value, netnode.suptag if tag is None else tag)
    ...
    def fitems(cls, nodeidx, type=None, tag=None):
        ...
        description = "{:#x}".format(nodeidx) if isinstance(nodeidx, internal.types.integer) else "{!r}".format(nodeidx)
        raise internal.exceptions.InvalidTypeOrValueError(u"{:s}.fitems({:#x}, type={!s}) : An unsupported type ({!r}) was requested for the netnode's supval.".format('.'.join([__name__, cls.__name__]), description, type, type))
    ...
    def ritems(cls, nodeidx, type=None, tag=None):
        ...
        description = "{:#x}".format(nodeidx) if isinstance(nodeidx, internal.types.integer) else "{!r}".format(nodeidx)
        raise internal.exceptions.InvalidTypeOrValueError(u"{:s}.ritems({:#x}, type={!s}) : An unsupported type ({!r}) was requested for the netnode's supval.".format('.'.join([__name__, cls.__name__]), description, type, type))
    ...
    def fall(cls, nodeidx, type=None, tag=None):
        ...
        description = "{:#x}".format(nodeidx) if isinstance(nodeidx, internal.types.integer) else "{!r}".format(nodeidx)
        raise internal.exceptions.InvalidTypeOrValueError(u"{:s}.fall({:#x}, type={!s}) : An unsupported type ({!r}) was requested for the netnode's supval.".format('.'.join([__name__, cls.__name__]), description, type, type))
    ...
    def rall(cls, nodeidx, type=None, tag=None):
        ...
        description = "{:#x}".format(nodeidx) if isinstance(nodeidx, internal.types.integer) else "{!r}".format(nodeidx)
        raise internal.exceptions.InvalidTypeOrValueError(u"{:s}.rall({:#x}, type={!s}) : An unsupported type ({!r}) was requested for the netnode's supval.".format('.'.join([__name__, cls.__name__]), description, type, type))
...
class hash(object):
    ...
    def fall(cls, nodeidx, type=None, tag=None):
        ...
        description = "{:#x}".format(nodeidx) if isinstance(nodeidx, internal.types.integer) else "{!r}".format(nodeidx)
        raise internal.exceptions.InvalidTypeOrValueError(u"{:s}.fall({:#x}, type={!r}) : An unsupported type ({!r}) was requested for the netnode's hash.".format('.'.join([__name__, cls.__name__]), description, type, type))
