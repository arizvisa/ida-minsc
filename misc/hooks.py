...
class structurenaming(changingchanged):
    ...
    def deleted(cls, struc_id):
        ...
        tags = internal.tagindex.structure.get(struc_id)
        ...
        [ internal.tagindex.structure.decrement(struc_id, tag) for tag in tags if internal.tagindex.tags.has(tag) ]
        return
    ...
    def updater(cls):
        ...
        elif not renamed[0] and '__name__' not in internal.tagindex.structure.get(newsid):
            internal.tagindex.structure.increment(newsid, '__name__')
...
class membernamingcommon(changingchanged):
    ...
    def updater(cls):
        ...
        # Otherwise, the name was cleared to a default, which we'll decrement.
            ...
            internal.tagindex.members.decrement(mid, '__name__') if '__name__' in internal.tagindex.members.get(mid) else ()
        ...
        elif not gold and '__name__' not in internal.tagindex.members.get(mid):
            internal.tagindex.members.increment(mid, '__name__')
    ...
    def updater(cls):
        ...
        if (oldsid, oldmid) == (newsid, newmid):
            ...
            # If the change removed the type, then decrement the reference.
                ...
                internal.tagindex.members.decrement(mid, '__typeinfo__') if '__typeinfo__' in internal.tagindex.members.get(mid) else ()
            ...
            elif oldtyped and '__typeinfo__' not in internal.tagindex.members.get(mid):
                internal.tagindex.members.increment(mid, '__typeinfo__')
        ...
        if '__typeinfo__' in internal.tagindex.members.get(mid):
    ...
    def member_updater(cls, ltc, ordinal, changes):
        ...
        for count, old, new in changes:
            ...
            # information for the specified identifier.
                ...
                removed = internal.tagindex.members.erase(sid, [mid])
