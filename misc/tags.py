...
class function(object):
    ...
    def name(cls, ea):
        ...
        # use the declaration module to encode it into something parsable.
        if mangled_t == idaapi.FF_DATA:
            logging.warning(u"{:s}.name({:#x}) : An unexpected type {:s} ({:#x}) was detected for the mangled function name belonging to the function at address {:#x}.".format('function', ea, 'FF_DATA', mangled_t, ea))
        return declaration.mangled.parsable(fname) or fname or ''
