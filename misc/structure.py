...
class v9members(object):
    ...
    def remove_slice(cls, type, slice, *offset):
        ...
        for mid, mname, mindex, moffset, msize in listable:
            ...
            elif not is_union and v9members.has_offset(ti, moffset - base) and not(next(cls.at_offset(ti, moffset - base))[-1].is_gap()):
...
class members_t(object):
    ...
    __members_matcher.combinator('tagged', utils.fcompose(utils.fcompose, utils.fcondition(utils.finstance(internal.types.bool, internal.types.integer), utils.finstance(internal.types.string))(utils.fcondition(operator.truth)(utils.fcompose(utils.fdiscard(internal.tags.select.members), utils.fpartial(utils.imap, operator.itemgetter(0)), utils.fpartial(utils.imap, operator.attrgetter('id')), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(utils.fdiscard(internal.tags.select.members), utils.fpartial(utils.imap, operator.itemgetter(0)), internal.types.set, utils.fpartial(utils.fpartial, utils.fcompose(operator.contains, operator.not_)))), utils.fcompose(internal.tags.select.members, utils.fpartial(utils.itermap, operator.itemgetter(0)), utils.fpartial(utils.imap, operator.attrgetter('id')), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)), utils.fcompose(internal.types.set, internal.tags.select.members, utils.fpartial(utils.itermap, operator.itemgetter(0)), utils.fpartial(utils.imap, operator.attrgetter('id')), internal.types.set, utils.fpartial(utils.fpartial, operator.contains)))), 'id')
